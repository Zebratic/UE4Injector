...
// Just a bunch of structure to make the source code cleaner.
// Took me a while, but now the source code looks professional xd
// idfk what im doing at this point lmfao
